  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved account as @account" do
        ...
        post :create, {:account => { "username" => "invalid value" }}, valid_session
        expect(assigns(:account)).to be_a_new(Account)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested account" do
        ...
        expect_any_instance_of(Account).to receive(:update).with({ "username" => "MyString" })
        put :update, {:id => account.to_param, :account => { "username" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the account as @account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Account).to receive(:save).and_return(false)
        put :update, {:id => account.to_param, :account => { "username" => "invalid value" }}, valid_session
        expect(assigns(:account)).to eq(account)
      end
